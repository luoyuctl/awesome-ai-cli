...
| **[RoleCraft](https://github.com/rolecraft-sh/rolecraft)** | Install AI agent skills as roles & behaviors from any source. Works with 86 coding agents (opencode, claude-code, cursor, etc.) | `npm i -g rolecraft` | ⭐⭐⭐⭐ | ❌ | ✅ |
